...
import { formula_cgarm_from_IndexUnit, formula_index_unit_cn_235, formula_mac_cn_235, formula_max_cn_235 } from "../wab/formula";
...
export class CN235WabCalculator extends WabCalculator {
  ...
  private generatePoint(name: string, weightData: weight | null, weightAxis: Axis, indexUnitAxis: Axis): Point | null {
    if (weightData) {
      const WMac = (formula_max_cn_235(weightData.arm.value));
